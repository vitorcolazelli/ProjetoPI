			...
			<div class="row">
				<div class="form-group col-md-8">
					<label for="cpf">CPF: </label> <input type="text"
						class="form-control" name="cpf" id="cpf" maxlength="13"
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label for="fone">Telefone: </label> <input type="tel"
						class="form-control" name="fone" id="fone" required maxlength="12"
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label for="pais">Pais: </label> <input type="text"
						class="form-control" name="pais" id="pais" required maxlength="40"
			...
			<div class="row">
				<div class="form-group col-md-4">
					<label for="endereco">CEP: </label> <input type="text"
						class="form-control" name="cep" id="cep" required maxlength="12"
			...
			<div class="row">
				<div class="form-group col-md-6">
					<label for="estado">Numero: </label> <input type="text"
						...
						maxlength="12" placeholder="nª" required />
				</div>
				<div class="form-group col-md-6">
