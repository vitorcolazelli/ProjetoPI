...
<link href="css/TelaSmartwatches.css" rel="stylesheet">
</head>

<c:import url="header.jsp"/>
		<c:import url="Menu.jsp"/>
<div id="main" class="container">
<div id="main" class="containerSmartwatches">
<div class="TopoSmartwatches">
<strong>  
<a class="inicioBotao" href="TelaInicial.jsp" title="Voltar à página inicial">Inicio</a>
    <span>></span>          <span>Smartwatches</span> </strong>  </div>
<h1 class="TituloSmartwatches"><strong>Smartwatches</strong></h1>
</div>
