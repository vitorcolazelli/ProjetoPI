...
<link href="css/TelaFones.css" rel="stylesheet">
</head>

<c:import url="header.jsp" />
<c:import url="Menu.jsp" />
<div id="main" class="container">
	<div id="main" class="containerFones">
		<div class="TopoFones">
			<strong> <a class="inicioBotao" href="TelaInicial.jsp"
				title="Voltar à página inicial">Inicio</a> <span>></span> <span>Fones</span>
			</strong>
		</div>
		<h1 class="TituloFones">
			<strong>Fones</strong>
		</h1>
	</div>
