...
public class ProdutoDAO {
	...
	public ArrayList<Produto> listarApple() throws IOException {
		Produto produto;
		ArrayList<Produto> lista = new ArrayList<>();
		String sqlSelect = "SELECT idProduto, nome, valor, imagem_produto FROM projetopi.produto where fk_IdColecao = 7";
		try (Connection conn = ConnectionFactory.obtemConexao();
				PreparedStatement stm = conn.prepareStatement(sqlSelect);) {
				try (ResultSet rs = stm.executeQuery();) {
				while (rs.next()) {
	...
	public ArrayList<Produto> listarXiaomi() throws IOException {
		Produto produto;
		ArrayList<Produto> lista = new ArrayList<>();
		String sqlSelect = "SELECT idProduto, nome, valor, imagem_produto FROM projetopi.produto where fk_IdColecao = 1";
		try (Connection conn = ConnectionFactory.obtemConexao();
				PreparedStatement stm = conn.prepareStatement(sqlSelect);) {
				try (ResultSet rs = stm.executeQuery();) {
				while (rs.next()) {
	...
	public ArrayList<Produto> listarSmartWatch() throws IOException {
		Produto produto;
		ArrayList<Produto> lista = new ArrayList<>();
		String sqlSelect = "SELECT idProduto, nome, valor, imagem_produto FROM projetopi.produto where fk_IdColecao = 4";
		try (Connection conn = ConnectionFactory.obtemConexao();
				PreparedStatement stm = conn.prepareStatement(sqlSelect);) {
				try (ResultSet rs = stm.executeQuery();) {
				while (rs.next()) {
	...
	public ArrayList<Produto> listarFones() throws IOException {
		Produto produto;
		ArrayList<Produto> lista = new ArrayList<>();
		String sqlSelect = "SELECT idProduto, nome, valor, imagem_produto FROM projetopi.produto where fk_IdColecao = 5";
		try (Connection conn = ConnectionFactory.obtemConexao();
				PreparedStatement stm = conn.prepareStatement(sqlSelect);) {
				try (ResultSet rs = stm.executeQuery();) {
				while (rs.next()) {
	...
	public ArrayList<Produto> listarSamsung() throws IOException {
		Produto produto;
		ArrayList<Produto> lista = new ArrayList<>();
		String sqlSelect = "SELECT idProduto, nome, modelo, valor, capacidade, cor, imagem_produto, quantidadeEstoque, fk_IdColecao FROM projetopi.produto where fk_IdColecao = 3";
		try (Connection conn = ConnectionFactory.obtemConexao();
				PreparedStatement stm = conn.prepareStatement(sqlSelect);) {
				try (ResultSet rs = stm.executeQuery();) {
				while (rs.next()) {
